...
function loadQuiz() {
 ...
 quizDetailEl.innerHTML = `<p>${currentQuiz + 1} из ${quizData.length}</p>`;
}
...
function nextQuestion() {
 ...
 if (currentQuiz < quizData.length) {
  ...
  quiz.innerHTML = `<h2>Вы ответили ${score}/${quizData.length} вопросов правильно</h2>
    <button type="button" onclick="location.reload()">Начать заново</button>
    `;
